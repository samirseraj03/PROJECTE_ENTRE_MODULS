        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            ...
            <div class="btn-group me-3">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li><button class="dropdown-item" type="button"><a class="link-success link-offset-2 link-underline link-underline-opacity-0" href="{{ route('new_company') }}">Enquestes</a></button></li>
